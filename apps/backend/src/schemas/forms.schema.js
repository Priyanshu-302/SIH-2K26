...
export const generateFormsRequestSchema = z.object({
  body: z.object({
    ...
    conversationText: z.string().max(100000).optional(),
    customInputs: z.object({
      applicantName: z.string().max(500).optional(),
      legalStatus: z.string().max(200).optional(),
      address: z.string().max(1000).optional(),
      email: z.string().email().optional(),
      signatory: z.string().max(200).optional(),
      inventionTitle: z.string().max(1000).optional(),
      inventionDescription: z.string().max(20000).optional(),
